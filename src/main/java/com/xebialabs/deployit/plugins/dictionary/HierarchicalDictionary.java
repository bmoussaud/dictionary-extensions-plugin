...
public class HierarchicalDictionary extends Dictionary {
	...
	@Property(description = "The dictionaries list, the data contained in the first dictionaries will overide the data of the next dictionary, and so on...", required = false)
